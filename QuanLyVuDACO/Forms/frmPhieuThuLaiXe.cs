...
{
    public partial class frmPhieuThuLaiXe : DevExpress.XtraEditors.XtraForm
    {
        public frmPhieuThuLaiXe()
        {
            InitializeComponent();
        }
        public frmPhieuThuLaiXe(int IDPhieuThu)
        {
            InitializeComponent();
            _IDPhieuThu = IDPhieuThu;
        }
        public frmPhieuThuLaiXe(string MaKH)
        {
            InitializeComponent();
            _MaKH = MaKH;
        }
