...
{
    public partial class frmChiNCC : DevExpress.XtraEditors.XtraForm
    {
        public frmChiNCC(DataTable dt)
        {
            InitializeComponent();
        ...
        private void frmChiNCC_FormClosing(object sender, FormClosingEventArgs e)
        {
