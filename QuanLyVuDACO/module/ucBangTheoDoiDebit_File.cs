...
{
    public partial class ucBangTheoDoiDebit_File : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBangTheoDoiDebit_File()
        {
            InitializeComponent();
        ...
        public static DateTime _NgayXuatHD = new DateTime();
        ...
        private void btnXuatHoaDon_Click(object sender, EventArgs e)
        {
            ...
            if(isCheck)
            {
                ...
                _SoHoaDon = "";
                Form frm = new Forms.frmXuatHoaDon();
                frm.ShowDialog();
                if(_SoHoaDon!="")
                {
                    string key = "";
                    ...
                    if(key.Length>0)
                    {
                        ...
                        client.FileDeBit_XuatHoaDon(true, key, _SoHoaDon, _NgayXuatHD);
                    }
                }
                else
                {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                gridView2.ExportToXlsx(dialog.SelectedPath + "/CacLoHangDaLapFile.xlsx");
            }
        }
