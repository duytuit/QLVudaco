...
{
    public partial class ucCongNoGiaoNhan : DevExpress.XtraEditors.XtraUserControl
    {
        public ucCongNoGiaoNhan()
        {
            InitializeComponent();
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (arr1.Length >= 3 && arr2.Length >= 3 && arr1[0].Trim() != "" && arr2[0].Trim() != "")
                {
                    ...
                    gridControl1.DataSource = client.CongNoTongHopGiaoNhan(Ngay1, Ngay2, tk);
        ...
        private void repositoryItemCT_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (arr1.Length >= 3 && arr2.Length >= 3 && arr1[0].Trim() != "" && arr2[0].Trim() != "")
                {
                    ...
                    string ten = bandedGridView1.GetFocusedRowCellValue("TenGiaoNhan").ToString().Trim();
                    Forms.frmCongNoGiaoNhan_CT frm = new Forms.frmCongNoGiaoNhan_CT(Ngay1, Ngay2, tk, ten);
                    frm.ShowDialog();
                }    
            }
            catch (Exception ex)
