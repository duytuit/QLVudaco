...
{
    public partial class ucPhieuChiCon : DevExpress.XtraEditors.XtraUserControl
    {
        public ucPhieuChiCon()
        {
            InitializeComponent();
        }
        ...
        private void ucPhieuChi_Load(object sender, EventArgs e)
        {
            ...
            repositoryItemDsChi.DataSource = client.DanhsachChi();
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            if (arr1.Length >= 3 && arr2.Length >= 3 && arr1[0].Trim() != "" && arr2[0].Trim() != "")
            {
                ...
                if (Ngay1.Year == 1 || Ngay2.Year == 1)
                  ...
                  gridControl2.DataSource = client.DanhSachPhieuChi_Con_TheoNgay(Ngay1, Ngay2);
            }
        }

        private void btnThemMoi_Click(object sender, EventArgs e)
        {
            Form frm = new Forms.frmPhieuChi_Con();
            frm.ShowDialog();
            btnXem_Click(sender, e);
        }
        ...
        private void repositoryItemSua_Click(object sender, EventArgs e)
        {
            ...
            string _maChi = gridView2.GetFocusedRowCellDisplayText("MaChi").Trim();
                ...
                Form frm = new Forms.frmPhieuChi_Con(_IDPhieuChi);
                frm.ShowDialog();
            btnXem_Click(sender, e);
        }
        ...
        private void gridView2_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            try
            {
                if(e.RowHandle>=0)
                {
                    ...
                    gridControl1.DataSource = client.DanhSachPhieuChi_Con_CT_TheoSoChungTu(_soChungTu);
                }    
            }
            catch (Exception)
            {
        ...
        {
           // gridControl2.DataSource = client.DanhSachPhieuChi_Con_TheoSoFile(txtSoFile.Text);
           // gridControl1.DataSource = client.DanhSachPhieuChi_Con_CT_TheoSoFile(txtSoFile.Text);
        }
        ...
        private void repositoryItemIn_Click(object sender, EventArgs e)
        {
            ...
            DateTime _NgayHachToan = DateTime.Parse(gridView2.GetFocusedRowCellValue("NgayHachToan").ToString().Trim());
                DataTable dt = client.DanhSachPhieuChi_Con_CT_TheoSoChungTu(_soChungTu);
                reports.rpt_PhieuChi_Con rpt = new reports.rpt_PhieuChi_Con(dt, _NgayHachToan);
                rpt.ShowPreview();
        }
    }
}
