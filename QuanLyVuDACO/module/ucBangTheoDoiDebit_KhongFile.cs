...
{
    public partial class ucBangTheoDoiDebit_KhongFile : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBangTheoDoiDebit_KhongFile()
        {
            InitializeComponent();
