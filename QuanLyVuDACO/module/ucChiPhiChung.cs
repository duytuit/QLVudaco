...
{
    public partial class ucChiPhiChung : DevExpress.XtraEditors.XtraUserControl
    {
        public ucChiPhiChung()
        {
            InitializeComponent();
            gridView3.OptionsView.ShowGroupPanel = true;
            gridView3.GroupPanelText = "Chi tiết phân bổ chi phí chung";
        }
        ...
        {
            frmTaoKhauHao frm = new frmTaoKhauHao(khauhao._khauhaochiphichung);
            frm.ShowDialog();
            LoadKhauHao();
        }
        private void LoadKhauHao()
        {
            ...
            {
                gridControl1.DataSource = kh.GetKhauHao(khauhao._khauhaochiphichung);
            }
        }
        ...
        private void LoadPhanBoKhauHao()
        {
            ...
            {
                gridControl2.DataSource = pbkh.GetPhanBoKhauHao(khauhao._khauhaochiphichung);
            }
        }
        ...
        {
            frmPhanBoKhauHao frm = new frmPhanBoKhauHao(khauhao._khauhaochiphichung);
            frm.ShowDialog();
            LoadPhanBoKhauHao();
        }
