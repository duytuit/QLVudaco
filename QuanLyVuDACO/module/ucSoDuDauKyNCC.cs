...
{
    public partial class ucSoDuDauKyNCC : DevExpress.XtraEditors.XtraUserControl
    {
        ServiceReference1.WebService1SoapClient client = new ServiceReference1.WebService1SoapClient();
        private readonly List<dynamic> LoaiCongNo = new[]
         {
            new { Id = 0, Name = "Phí dịch vụ đầu kỳ" },
            new { Id = 1, Name = "Phí nâng hạ đầu kỳ" }
        }.ToList<dynamic>();
        private int _id = 0;
        public ucSoDuDauKyNCC()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            {
                gridControl1.DataSource = sd.GetDataNCC();
            }
        }
        private void repositoryItemHyperLinkSua_Click(object sender, EventArgs e)
        {
            ...
            using (var _db = new clsKetNoi())
            {
                ...
                if (_row != null)
                {
                    ...
                    cboNCC.EditValue = _row["MaDoiTuong"].ToString();   // hoặc "MaNhaCungCap" tùy tên cột
        ...
        private void ClearForm()
        {
            ...
            cboNCC.EditValue = null;   // clear chọn trong GridLookUpEdit
            ...
            try
            {
                using (var _db = new clsKetNoi())
                {
                    ...
                    var p = new
                    {
                        ...
                        MaDoiTuong = cboNCC.EditValue?.ToString(),
