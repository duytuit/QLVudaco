...
{
    public partial class ucTaiSanCoDinh : DevExpress.XtraEditors.XtraUserControl
    {
        public ucTaiSanCoDinh()
        {
            InitializeComponent();
            gridView3.OptionsView.ShowGroupPanel = true;
            gridView3.GroupPanelText = "Chi tiết phân bổ khấu hao";
        }
        ...
        {
            frmTaoKhauHao frm = new frmTaoKhauHao(khauhao._khauhaotaisan);
            frm.ShowDialog();
            LoadKhauHao();
        }
        private void LoadKhauHao()
        {
            ...
            {
                gridControl1.DataSource = kh.GetKhauHao(khauhao._khauhaotaisan);
            }
        }
        ...
        private void LoadPhanBoKhauHao()
        {
            ...
            {
                gridControl2.DataSource = pbkh.GetPhanBoKhauHao(khauhao._khauhaotaisan);
            }
        }
        ...
        {
            frmPhanBoKhauHao frm = new frmPhanBoKhauHao(khauhao._khauhaotaisan);
            frm.ShowDialog();
            LoadPhanBoKhauHao();
        }
