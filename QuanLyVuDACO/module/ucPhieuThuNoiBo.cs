...
{
    public partial class ucPhieuThuNoiBo : DevExpress.XtraEditors.XtraUserControl
    {
        public ucPhieuThuNoiBo()
        {
            InitializeComponent();
        }
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            if (arr1.Length >= 3 && arr2.Length >= 3 && arr1[0].Trim() != "" && arr2[0].Trim() != "")
            {
                ...
                gridControl2.DataSource = client.DanhSachPhieuThu_NoiBo_TheoNgay(Ngay1, Ngay2);
            }
        }
        ...
        {
            client.DanhSachPhieuChi_NoiBo_Xoa2(gridView2.GetFocusedRowCellDisplayText("SoChungTu"));
            btnXem_Click(sender, e);
        }
        ...
        private void gridView2_CustomRowCellEditForEditing(object sender, DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs e)
        {
            try
            {
                if(e.RowHandle>=0)
                {
                    ...
                    gridControl1.DataSource = client.DanhSachPhieuThu_NoiBo_CT_TheoSoChungTu(_soChungTu);
                }    
            }
            catch (Exception)
            {
