...
{
    public partial class rpt_CongNoNCC : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_CongNoNCC()
        {
            InitializeComponent();
        }
        public rpt_CongNoNCC(DataTable dt,string tg,double dauky,double thanhtoan,string ten)
        {
            InitializeComponent();
            _dt = dt;
            _tg = tg;
