...
{
    public partial class rpt_PhieuThuLaiXe : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_PhieuThuLaiXe()
        {
            InitializeComponent();
        }
        public rpt_PhieuThuLaiXe(DataTable _dt,DateTime _Ngay)
        {
            InitializeComponent();
            Ngay = _Ngay;
            dt = _dt;
