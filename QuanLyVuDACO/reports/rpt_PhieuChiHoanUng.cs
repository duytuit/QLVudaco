...
{
    public partial class rpt_PhieuChiHoanUng : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_PhieuChiHoanUng()
        {
            InitializeComponent();
        }
        public rpt_PhieuChiHoanUng(DataTable _dt,DateTime _Ngay)
        {
            InitializeComponent();
            Ngay = _Ngay;
            dt = _dt;
