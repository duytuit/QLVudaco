...
{
    public partial class rpt_PhieuThuHoanCuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_PhieuThuHoanCuoc()
        {
            InitializeComponent();
        }
        public rpt_PhieuThuHoanCuoc(DataTable _dt,DateTime _Ngay)
        {
            InitializeComponent();
            Ngay = _Ngay;
            dt = _dt;
