...
{
    public partial class rpt_CongNoKH : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_CongNoKH()
        {
            InitializeComponent();
        }
        public rpt_CongNoKH(DataTable dt,string tg,double dauky,double thanhtoan,string ten)
        {
            InitializeComponent();
            _dt = dt;
            _tg = tg;
