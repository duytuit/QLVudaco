...
{
    public partial class ucLoiNhuanTheoXe : DevExpress.XtraEditors.XtraUserControl
    {
        public ucLoiNhuanTheoXe()
        {
            InitializeComponent();
        }
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            if (arr1.Length >= 3 && arr2.Length >= 3 && arr1[0].Trim() != "" && arr2[0].Trim() != "")
            {
                ...
                DataTable dt = new DataTable();
                 dt = client.ThongKeLoiNhuan_TheoXe(Ngay1, Ngay2);
                string _tg = string.Format("Từ ngày {0} đến ngày {1}", dtpTuNgay.Text, dtpDenNgay.Text);
                reports.rpt_LoiNhuanTheoXe rpt = new rpt_LoiNhuanTheoXe(dt,_tg);
