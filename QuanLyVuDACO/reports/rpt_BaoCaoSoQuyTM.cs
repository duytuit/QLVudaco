...
{
    public partial class rpt_BaoCaoSoQuyTM : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_BaoCaoSoQuyTM()
        {
            InitializeComponent();
        }
        public rpt_BaoCaoSoQuyTM(DataTable dt,string tg, double dauky)
        {
            InitializeComponent();
            _tg = tg;
            _dt = dt;
