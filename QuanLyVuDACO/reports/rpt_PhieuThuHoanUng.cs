...
{
    public partial class rpt_PhieuThuHoanUng : DevExpress.XtraReports.UI.XtraReport
    {
        public rpt_PhieuThuHoanUng()
        {
            InitializeComponent();
        }
        public rpt_PhieuThuHoanUng(DataTable _dt,DateTime _Ngay)
        {
            InitializeComponent();
            Ngay = _Ngay;
            dt = _dt;
        ...
        private void lblTong_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            double tong = 0;
